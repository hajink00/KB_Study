...
public class SetEx {
    ...
    public void ex1() {
        ...
        System.out.println(set); // [체리, 포도, 오렌지, 딸기]
        // HashSet은 순서 유지 X
        ...
        // set에 null 저장 가능 하나 1개만 가능(중복 X)
        set.add(null);
        set.add(null);
        set.add(null);
        ...
        //    (반환형)
        // - set에 저장된 객체 중 e와 똑같은 객체(=요소)가 있으면 true,
        //   없으면 false
